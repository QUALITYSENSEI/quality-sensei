...
import rawLabData from '@/data/labs/selenium-grid.json';
...
const SeleniumGridLab: React.FC = () => {
  ...
  return (
    <MainLayout
      title="Selenium Grid Lab | Quality Sensei"
      description="Learn how to set up and use Selenium Grid for distributed and parallel test execution across multiple browsers and operating systems."
      keywords="selenium grid, distributed testing, parallel execution, test automation, cross-browser testing"
    >
...
export default SeleniumGridLab;